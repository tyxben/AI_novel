...
- character_state: 角色状态（如"受伤"、"突破境界"、"死亡"、"离开去执行任务"）
- location: 地点（如"到达某城"、"进入某洞府"）
- event: 重要事件（如"击败某人"、"获得宝物"、"召开发布会"）
- relationship: 角色关系（如"结拜"、"反目"、"师徒"）

特别注意提取以下事实（这些是容易产生矛盾的关键信息）：
- 角色的生死状态变化（死亡、重伤、牺牲等不可逆状态）
- 角色说要去做某事但尚未交代结果的情况
- 具体的数字、距离、时间等量化信息（如"距离0.3光年"、"三千人"）
- 提出的方案/计划及其结果（成功、失败、放弃）
