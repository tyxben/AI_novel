...
class NarrativeRebuildService:
    ...
    def __init__(self, project_path: str, llm_client=None) -> None:
    ...
    def _auto_fulfill_debts(
        ...
        """Try to auto-detect which debts were fulfilled in later chapters.

        Simple heuristic: extract 3-5 distinctive terms from each debt
        description, then search subsequent chapters for those terms.
        If found, mark the debt as fulfilled.
